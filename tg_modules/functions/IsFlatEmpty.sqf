/*
	...
	_this: ARRAY
		...
		1: NUMBER - Radius of searching for objects via nearObjects
		2: ARRAY - Array of STRING. If object's kindOf matches one of the strings, it's ignored
		3: ARRAY - params passed to isFlatEmpty, which is used to evaluate steepness 
